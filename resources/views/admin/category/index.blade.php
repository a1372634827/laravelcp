	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tr class="text-c">
                   ...
                   <td><input type="text" style="width:20px;"onchange="changeOrder(this,{{$v->cate_id}})" value="{{$v->cate_order}}" name=""/></td>
					<td>{{$v->cate_id}}</td>
                    <td>{{$v->_cate_name}}</td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">{{$v->cate_title}}</u></td>
					<td>H-ui</td>
...
<script type="text/javascript" src="{{asset('resources/org/layer/lib/layer.js')}}"></script>
