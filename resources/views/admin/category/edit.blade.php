...
@section('content')
	...
	<title>童梦之家</title>
	<meta name="keywords" content="童梦之家后台管理系统">
	<meta name="description" content="童梦之家--儿童学习，音乐，律动。">
</head>
<body>
	...
	<form class="form form-horizontal" id="form-article-add" action="{{url('admin/category')}}" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="cate_title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">关键词：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle2" name="cate_keywords">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle2" name="cate_name">
			</div>
		</div>
		{{--<div class="row cl">--}}
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="articlesort" name="cate_order">
			</div>
		</div>
		{{--<div class="row cl">--}}
			{{--<label class="form-label col-xs-4 col-sm-2">关键词：</label>--}}
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="cate_description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
